...
set(CMAKE_C_FLAGS                  "${WASI_TARGET_FLAGS} -D_WASI_EMULATED_GETPID -nostdlib ${WASI_SHIM}" CACHE INTERNAL "")
set(CMAKE_C_COMPILER_TARGET        "wasm32-wasip1")
set(CMAKE_C_COMPILER               "/usr/bin/clang")

set(CMAKE_CXX_FLAGS                "${WASI_TARGET_FLAGS} -D_WASI_EMULATED_GETPID -nostdlib ${WASI_SHIM}" CACHE INTERNAL "")
